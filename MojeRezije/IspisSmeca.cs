...
{
    public partial class IspisSmeca : Form
    {
        ...
        private void IspisSmeca_Load(object sender, EventArgs e)
        {
        ...
        public void RefreshDataTable()
        {
            ...
            var con = DataBase.GetSqlkonekcija();
            con.Open();
            string sql = "SELECT ID, Email, Izracun,Mjesec,Godina From Smece WHERE Email='" + PrijavaKorisnika.ImePrijavljenog + "'";
        ...
        private void Btn_Obrisi_Click(object sender, EventArgs e)
        {
            ...
            string Obrisi = "Delete from Smece where ID='" + str + "'";
        ...
        private void Cb_GodinaSmece_SelectedIndexChanged(object sender, EventArgs e)
        {
            double ukupno = 0;
            ...
            SqlCommand Uzmi = new SqlCommand("SELECT Izracun, Godina FROM Smece Where Email = '" + PrijavaKorisnika.ImePrijavljenog + "'AND Godina = '" + cb_GodinaSmece.Text + "'", con);
            SqlDataReader Citac;
            ...
            lbl_Ispis.Text = "Vasa Ukupna cijena za godinu " + cb_GodinaSmece.Text + " iznosi " + ukupno + "kn";
