...
{
    public partial class IspisStruje : Form
    {
        ...
        private void IspisStruje_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_Obrisi_Click(object sender, EventArgs e)
        {
            ...
            string Obrisi = "Delete from Struja where ID='" + str + "'";
        ...
        public void RefreshDataTable()
        {
            ...
            var con = DataBase.GetSqlkonekcija();
            con.Open();
            string sql = "SELECT ID, Email, Izracun,Mjesec,Godina From Struja  WHERE Email='" + PrijavaKorisnika.ImePrijavljenog + "'";
        ...
        private void Cb_GodinaStruja_SelectedIndexChanged(object sender, EventArgs e)
        {
            double ukupno = 0;
            var con = DataBase.GetSqlkonekcija();
            con.Open();

            SqlCommand Uzmi = new SqlCommand("SELECT Izracun, Godina FROM Struja Where Email = '" + PrijavaKorisnika.ImePrijavljenog + "'AND Godina = '" + cb_GodinaStruja.Text + "'", con);
            SqlDataReader Citac;
            ...
            lbl_Ispis.Text = "Vasa Ukupna cijena za godinu " + cb_GodinaStruja.Text + " iznosi " + ukupno + "kn";
